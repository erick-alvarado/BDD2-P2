...
----ALTERNATIVETITLE
insert into AlternativeTitle values (1,1,1,1,1,1,'Rey de la selva','si','si');
insert into AlternativeTitle values (2,2,2,2,2,2,'miedo al jugar','si','si');
insert into AlternativeTitle values (3,3,3,3,1,1,'El matrix','si','si');
insert into AlternativeTitle values (4,4,4,4,2,2,'El mentiroso','si','si');
insert into AlternativeTitle values (5,5,5,5,1,1,'Conci a alguien pero no funciono','no','no');
insert into AlternativeTitle values (6,6,1,1,2,2,'Guerra de castas','Game of Thrones','no','no');
insert into AlternativeTitle values (7,7,2,2,1,1,'La infección','Chernobyl','no','no');
insert into AlternativeTitle values (8,8,3,3,2,2,'Tio Charlie','two and the half men','no','no');
insert into AlternativeTitle values (9,9,4,4,1,1,'Cosas de otro mundo','Stranger things','no','no');
insert into AlternativeTitle values (10,10,5,5,2,2,'El trabajo','The Office','no','no');
